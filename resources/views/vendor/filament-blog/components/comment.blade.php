...
<form action="{{ route('filamentblog.comment.store', ['post' => $post->slug]) }}" method="POST" id="comments">
    ...
    <div class="border-t-2 py-10">
        <div class="mb-7">
            <h3 class="mb-2 text-2xl font-semibold">Yorum Yap</h3>
        </div>
        <div class="mb-6">
            <label class="mb-2 block text-sm font-semibold" for="author-comment">Yorum *</label>
            <textarea name="comment" rows="4" placeholder="Yorumunuzu yazın..." type="text" id="author-comment"
