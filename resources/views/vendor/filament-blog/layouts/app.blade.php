...
{{--    <link rel="icon" href="{{ $setting?->faviconImage }}" type="image/x-icon" />--}}
    ...
    <link rel="mask-icon" href="{{ asset('favicons/safari-pinned-tab.svg') }}" color="#f97316">
            ...
            <div class="container mx-auto">
                ...
                <div class="mt-7 flex flex-wrap items-start justify-center gap-10 border-t border-slate-200 pt-5">
                    <div class="text-hurricane/50 text-sm font-medium">
                        © 2024 {{ $setting->organization_name ?? 'Almanyadayız' }}. All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
            ...
            <div class="mx-auto grid h-full max-w-lg grid-cols-3 justify-items-center items-center font-medium">
                ...
                <a href="{{ route('filamentblog.post.index') }}"
                   class="flex flex-col items-center justify-center px-2 py-1 hover:bg-gray-50 rounded transition">
                    ...
                    <span class="text-sm text-gray-500 hover:text-blue-600">Anasayfa</span>
                </a>
                ...
                <a href="{{ route('events.index') }}"
                   class="flex flex-col items-center justify-center px-2 py-1 hover:bg-gray-50 rounded transition">
                    ...
                    <span class="text-sm text-gray-500 hover:text-blue-600">Etkinlikler</span>
                </a>
                ...
                <a href="{{ route('filamentblog.post.all') }}"
                   class="flex flex-col items-center justify-center px-2 py-1 hover:bg-gray-50 rounded transition">
                    ...
                    <span class="text-sm text-gray-500 hover:text-blue-600">Tüm Gönderiler</span>
                </a>
            </div>
        </div>
